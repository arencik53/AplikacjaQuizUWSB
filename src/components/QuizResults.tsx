  ...
  return (
    <div className="h-full flex flex-col" style={{ padding: 'clamp(0.75rem, 2vh, 1.5rem) clamp(0.75rem, 3vw, 1.5rem)' }}>
      <div className="flex-1 flex flex-col overflow-hidden">
        {!showDetails && (
          <div className="text-center flex-shrink-0" style={{ marginBottom: 'clamp(0.75rem, 2vh, 1.25rem)' }}>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl shadow-2xl flex-shrink-0" style={{ padding: 'clamp(0.75rem, 2vh, 1.25rem)', marginBottom: 'clamp(0.75rem, 2vh, 1.25rem)' }}>
        ...
        {!showDetails ? (
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="flex items-center justify-between flex-shrink-0" style={{ marginBottom: 'clamp(0.5rem, 1.5vh, 1rem)' }}>
